...
This is **modern blogging platform** built with Next.js, featuring user authentication, blog post management, and a clean, intuitive interface.
...
Source code: [github.com/moysush/next-blogapp](https://github.com/moysush/next-blogapp)
